...
print('parent_children_dict.keys() = ',parent_children_dict.keys())
print('list(parent_children_dict.keys()) = ',list(parent_children_dict.keys()))
print("len(list(parent_children_dict.keys())) = ",len(list(parent_children_dict.keys())))
if len(list(parent_children_dict.keys())) == 0:
    print("copying ",orig_xml_file, " to  flat_xml_out.xml")
